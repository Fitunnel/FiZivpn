...
NC='\033[0m' # No Color
LICENSE_URL="https://raw.githubusercontent.com/Fitunnel/FiZivpn/main/ip"
...
echo -e "silakan hubungi admin https://wa.me/6285223659782 \n"
...
wget -O /root/zi.sh https://raw.githubusercontent.com/Fitunnel/FiZivpn/main/zi.sh
...
wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/Fitunnel/FiZivpn/main/zivpn_helper.sh
if [ $? -ne 0 ]; then
